...
public class Funcionario {
    ...
    public String cadastrar(String json) {
        new Persistencia().cadastrar(new Gson().fromJson(json, modelo.Funcionario.class));
    ...
    public String cadastrarLista(String json) {
        new Persistencia().cadastrar((List<Object>) new Gson().fromJson(json, new TypeToken<List<modelo.Funcionario>>(){}.getType()));
        return "Cadastrado com sucesso!";
    }
    ...
    public String atualizar(String json) {
        new Persistencia().atualizar(new Gson().fromJson(json, modelo.Funcionario.class));
    ...
    public String remover(@PathParam("id") long id) {
        new Persistencia().remover(new modelo.Funcionario(), id);
