...
public class Setor {
    ...
    public String cadastrarLista(String json) {
        return new Persistencia().cadastrar((List<Object>) new Gson().fromJson(json, new TypeToken<List<modelo.Setor>>() {
        }.getType()));
    }
    ...
    public String selecionar() {
        return new Gson().toJson(new Persistencia().selecionar(new modelo.Setor()));
    }
    ...
    public String selecionar(@PathParam("id") long id) {
        return new Gson().toJson(new Persistencia().selecionar(new modelo.Setor(), id));
    }
